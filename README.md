...
The input for this script is a list of URLs that are known to be archived in Archive-It, one URL per line. Once you have the list of URLs, run the script with the path to the input file as a parameter:

`php audit.php my_urls.txt`
